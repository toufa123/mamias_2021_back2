...
*/
(function(f){"function"===typeof define&&define.amd?define(["jquery","datatables2.net","datatables2.net-buttons"],function(c){return f(c,window,document)}):"object"===typeof exports?module.exports=function(c,e){c||(c=window);e&&e.fn.dataTable||(e=require("datatables2.net")(c,e).$);e.fn.dataTable.Buttons||require("datatables2.net-buttons")(c,e);return f(e,c,c.document)}:f(jQuery,window,document)})(function(f,c,e,h){c=f.fn.dataTable;f.extend(c.ext.buttons,{colvis:function(b,a){return{extend:"collection",
