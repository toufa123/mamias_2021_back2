     ...
     */
    {
        ...
        drawGraph: function () {
            var indicator = this, mainLinePoints = (indicator.points), pointsLength = mainLinePoints.length,
                ...
                }, intersectIndexColl = [], senkouSpanOptions = indicator.options.senkouSpan,
        ...
        getValues: function (series, params) {
            var period = params.period, periodTenkan = params.periodTenkan,
                periodSenkouSpanB = params.periodSenkouSpanB, xVal = series.xData, yVal = series.yData,
                xAxis = series.xAxis, yValLen = (yVal && yVal.length) || 0,
