...
var addEvent = U.addEvent, error = U.error, extend = U.extend, isArray = U.isArray, pick = U.pick,
    seriesType = U.seriesType, splat = U.splat;
import '../../Core/Series/Series.js';

var Series = H.Series, seriesTypes = H.seriesTypes, ohlcProto = H.seriesTypes.ohlc.prototype,
...
seriesType('sma', 'line',
     ...
     */
    {
        ...
        getValues: function (series, params) {
            var period = params.period, xVal = series.xData, yVal = series.yData, yValLen = yVal.length, range = 0,
                sum = 0, SMA = [], xData = [], yData = [], index = -1, i, SMAPoint;
